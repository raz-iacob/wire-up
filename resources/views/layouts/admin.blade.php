...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <flux:header sticky class="block! border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        <flux:navbar class="w-full md:hidden">
    ...
    <flux:main class="min-w-0"> {{ $slot }} </flux:main>
