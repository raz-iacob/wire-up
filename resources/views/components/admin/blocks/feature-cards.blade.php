...
<div class="flex flex-col gap-6">
    ...
    <div class="flex flex-col gap-2">
        ...
        <div
            wire:sort="reorderFeatureItems"
            wire:sort:group="feature-cards-{{ $block['id'] }}"
                    ...
                    <div class="flex items-center justify-between gap-3 bg-zinc-100 px-3 py-2 dark:bg-white/10">
                        ...
                        >
                            <flux:heading
                                size="sm"
                                class="truncate"
                            >{{ $itemTitle !== '' ? $itemTitle : __('Card :number', ['number' => $i + 1]) }}</flux:heading>
                        </button>
                        ...
                        <div wire:sort:ignore class="flex shrink-0 items-center gap-1">
                            ...
                            <flux:button
                                ...
                                icon="trash"
                                square
                                wire:click="removeFeatureItem('{{ $block['id'] }}', {{ $i }})"
                                :tooltip="__('Remove card')"
                            />
                        </div>
                    </div>
        ...
        <div>
            <flux:button
                size="sm"
                icon="plus"
                wire:click="addFeatureItem('{{ $block['id'] }}')"
    ...
    <div class="flex flex-col gap-4">
        ...
        <flux:switch
            wire:model.live="{{ $c }}.cardStyle"
            label="{{ __('Show cards with a background') }}"
            align="left"
        />
    </div>

    <div x-show="{{ $b }}?.cardStyle" x-cloak class="grid gap-4 md:grid-cols-2">
        <flux:color-picker
            wire:model="{{ $c }}.cardBg"
            clearable
