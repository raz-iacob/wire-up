...
Route::middleware('can:inbox.view')->group(function (): void {
...
Route::middleware('can:roles.view')->group(function (): void {
    Route::livewire('settings/roles', 'pages::admin.settings-roles')->name('settings-roles');
});
